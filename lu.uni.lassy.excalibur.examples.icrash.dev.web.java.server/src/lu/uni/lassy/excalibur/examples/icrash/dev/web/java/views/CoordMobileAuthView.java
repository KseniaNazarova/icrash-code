...
public class CoordMobileAuthView extends TabBarView implements View, Serializable {
	...
	public CoordMobileAuthView(String CoordID) {
		...
		HorizontalLayout crisesButtons3 = new HorizontalLayout();
		...
		/*GeneratedPropertyContainer gpcontainer = new GeneratedPropertyContainer(actCoordinator.getCrisesContainer());
	    gpcontainer.addGeneratedProperty("share", new PropertyValueGenerator<String>() { 	    	
			private static final long serialVersionUID = -2501180072317572826L;
			@Override
			public String getValue(Item item, Object itemId, Object propertyId) {
				return "Share"; // The caption
			}
			@Override
		...
		/*crisesTable.getColumn("share").setRenderer(new ButtonRenderer(e -> {			
		}));*/
		...
		shareByCrisisBtn.addClickListener(event -> {
			CrisisBean selectedCrisisBean = (CrisisBean) crisesTable.getSelectedRow();
			Integer thisCrisisID = new Integer(selectedCrisisBean.getID());
			PtBoolean res = actCoordinator.oeShareByCrisis(new DtCrisisID(new PtString(thisCrisisID.toString())));
			String iCrashURL = "/iCrash/"; 			
			Page.getCurrent().open(iCrashURL + MediaSelectionLauncher.mediaSelectionName, "_blank");
		});
